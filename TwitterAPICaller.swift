...
//    var api = Keys.self
    ...
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: Keys.apiKey, consumerSecret: Keys.secretKey)
...
//        print(parameters)
    ...
    func sendTweet(tweet: String, success: @escaping ()->(), failure: @escaping (Error)->()){
